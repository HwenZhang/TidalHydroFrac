...
casename = 'stokes_tidal_response_U09ma_L20000_A5e_15_n1_0_delta6e_19_tide0_00_slope0_05_C5e_7_inflow_U0'
...
A0 = 5.0e-15                       # Glen's law coefficient (ice softness, Pa^{-n}/s)
n = 1.0                            # Glen's law exponent
...
C = 5.00e7                         # Sliding law friction coefficient (Pa s^{1/n}/m)
...
slope_str = '0_05'                 # slope of the bed
...
nt_per_year = 0.05*1000            # Number of timesteps per year.
t_final = 50.0*3.154e7/1e0         # Final time (yr*sec_per_year).

# nt_per_year = 100*1000             # Number of timesteps per year. (tidal simulation)
# t_final = 5*0.5/365*3.154e7        # Final time (yr*sec_per_year). (tidal simulation)
