...
# Material parameters
A0 = 3.1689e-27                    # Glen's law coefficient (ice softness, Pa^{-n}/s)
...
eps_v0= 1.0e-15                    # Flow law regularization parameter
...
lake_depth = 10.0                  # lake water depth (m)
basin_depth = 15.0                 # basin depth (m)
lake_radius = 1.0e3                # lake size (m)

# Time-stepping parameters for tidal problems
# nt_per_year = 500*1000              # Number of timesteps per year.
nt_per_year = 500*1000                # Number of timesteps per year.
t_final = 10.0/365.0/2.0*3.154e7      # Final time (yr*sec_per_year).
