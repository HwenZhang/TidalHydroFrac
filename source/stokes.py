...
def weak_form_marine(u,p,tau,u_old,p_old,tau_old,u_test,p_test,tau_test,f,g_base,g_out,lake_load,ds,nu,T):
...
def stokes_solve_marine(mesh,F_h,t,w_old):
        ...
        # Solve for (u,p).
        Fw = weak_form_marine(u,p,tau,u_prev,p_prev,tau_prev,u_test,p_test,tau_test,f,g_base,g_out,lake_load,ds,nu,T)
        ...
        newton_prm['linear_solver'] = 'petsc'
